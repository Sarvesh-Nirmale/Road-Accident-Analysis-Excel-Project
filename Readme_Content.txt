...
An interactive Road Accident Dashboard built in Microsoft Excel,
providing data-driven insights into UK road casualties.
...
### Main Dashboard
![Dashboard](https://github.com/Sarvesh-Nirmale/Road-Accident-Analysis-Excel-Project/blob/master/Screenshots/Dashboard.png?raw=true)

### KPI Sheet
![KPI Preview](https://github.com/Sarvesh-Nirmale/Road-Accident-Analysis-Excel-Project/blob/master/Screenshots/KPI_Preview.png?raw=true)

### Monthly Trend
![Monthly Trend](https://github.com/Sarvesh-Nirmale/Road-Accident-Analysis-Excel-Project/blob/master/Screenshots/Montly_Trend.png?raw=true)

### Data Analysis Sheet
![Analysis Sheet](https://github.com/Sarvesh-Nirmale/Road-Accident-Analysis-Excel-Project/blob/master/Screenshots/Analysis_Sheet.png?raw=true)

---

## 📂 Dataset

**File:** `Road_Accident_Analysis.xlsx`

**Sheets:** Dashboard · Monthly Trend · Road Type · Road Surface ·
DayNight Casualties · Data · KPI · Data Analysis Sheet
...
The dashboard reveals a **12% decrease in casualties from 2021 to 2022**
(222K → 195K), with **cars accounting for ~80%** of all casualties.
Single carriageways and dry road surfaces remain the highest-risk
conditions. These insights empower stakeholders to prioritise
